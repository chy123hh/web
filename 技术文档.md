...
**校园帮帮送**（Campus Help Express）—— 校园跑腿互助平台
...
@EnableJpaRepositories(basePackages = "com.campushelp")
@EntityScan("com.campushelp")
@EnableAsync
...
子模块：com.campushelp.user、com.campushelp.task 等
